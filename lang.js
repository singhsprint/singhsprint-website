...
var SP_LANG = (function() {
  ...
  var translations = {
    ...
    'biz.pricing.note': {
      ...
      fr: 'Les prix affiches sont bases sur des vetements de qualite Gildan et incluent l\'impression. Les marques premium (Bella+Canvas, Comfort Colors, American Apparel, etc.) peuvent varier. Selectionnez un produit pour voir la ventilation par quantite et cotes d\'impression.'
    },
    ...
    'quote.step2.desc': { en: 'Drop your artwork to preview it on the mockup, then tell us how many of each size you need.', fr: 'Deposez votre visuel pour le previsualiser sur la maquette, puis indiquez les quantites par taille.' },
    'quote.step3.h': { en: 'How do we reach you?', fr: 'Comment vous joindre?' },
    'quote.step3.desc': { en: 'We\'ll send your quote by email, usually the same day.', fr: 'Nous vous enverrons votre soumission par courriel, souvent la meme journee.' },
