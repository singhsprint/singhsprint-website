...
var SP_LANG = (function() {
  ...
  var translations = {
    ...
    'home.diff.r5.us': { en: '100% in-house, at a shop you can walk into', fr: '100 % sur place, dans un atelier où vous pouvez entrer' },
    ...
    'whyus.cmp.sub': { en: "No trash talk, just the pattern everyone who's ordered shirts before will recognize.", fr: 'Pas de dénigrement — juste le scénario que reconnaîtra quiconque a déjà commandé des chandails.' },
    ...
    'whyus.cmp.r3.us': { en: '<strong>Photoreal mockup in about an hour</strong> &mdash; then a real printed sample you approve before the full run.', fr: '<strong>Maquette photoréaliste en environ une heure</strong> — puis un vrai échantillon imprimé que vous approuvez avant la production complète.' },
    ...
    'whyus.cmp.r5.us': { en: '<strong>100% in-house.</strong> DTG, DTF and embroidery under one roof you can literally walk into &mdash; 81A Sainte-Anne St.', fr: '<strong>100 % sur place.</strong> DTG, DTF et broderie sous un même toit où vous pouvez littéralement entrer — 81A, rue Sainte-Anne.' },
