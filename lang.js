...
var SP_LANG = (function() {
  ...
  var translations = {
    ...
    'home.diff.r5.us': { en: 'Every single order is processed by us. If a machine breaks, it\'s our problem, not yours.', fr: 'Chaque commande est traitée par nous. Si une machine brise, c\'est notre problème, pas le vôtre.' },
    'home.diff.r6.them': { en: '&ldquo;That\'s how the file came out&rdquo;', fr: '« C\'est le fichier qui était comme ça »' },
    'home.diff.r6.us': { en: 'Wrong print? Reprinted or replaced. Period.', fr: 'Impression ratée ? Réimprimée ou remplacée. Point.' },
    'home.diff.kicker': { en: 'Worst case: you get a free mockup and a real number, and walk away knowing what this should cost. The risk is on our side of the table. On purpose.', fr: 'Au pire : vous repartez avec une maquette gratuite et un vrai prix, en sachant exactement combien ça devrait coûter. Le risque est de notre côté de la table. C\'est voulu.' },
    'home.diff.cta': { en: 'Get a Free Quote &rarr;', fr: 'Soumission gratuite &rarr;' },
    'home.diff.more': { en: 'See the full comparison &rarr;', fr: 'Voir la comparaison complète &rarr;' },
    // FAQ
    ...
    // ===== ABOUT =====
    'footer.whyus': { en: 'Why us', fr: 'Pourquoi nous' },
    // ===== /why-us — the honest comparison page =====
    'whyus.hero.eyebrow': { en: 'The honest comparison', fr: 'La comparaison honnête' },
    'whyus.hero.h1': { en: "Most print shops make you pay to find out if they're any good.", fr: 'La plupart des imprimeries vous font payer pour découvrir si elles sont bonnes.' },
    'whyus.hero.p': { en: 'You send your logo, wait a week for a price, pay up front, and the first time you see your shirt is at pickup. We built Singhs Print to be the opposite of that. Judge for yourself.', fr: 'Vous envoyez votre logo, attendez une semaine pour un prix, payez d\'avance, et la première fois que vous voyez votre chandail, c\'est au ramassage. On a bâti Singhs Print pour être l\'exact contraire. Jugez par vous-même.' },
    'whyus.hero.cta': { en: 'Get a Free Quote &rarr;', fr: 'Soumission gratuite &rarr;' },
    'whyus.cmp.h2': { en: 'What sucks about ordering custom apparel, and what we did about it', fr: 'Ce qui est pénible quand on commande des vêtements personnalisés, et ce qu\'on a fait pour y remédier' },
    'whyus.cmp.sub': { en: "If you've ordered custom shirts before, you've lived the left column.", fr: 'Si vous avez déjà commandé des chandails personnalisés, vous avez vécu la colonne de gauche.' },
    ...
    'whyus.cmp.r5.us': { en: '<strong>Every single order is processed by us, start to finish.</strong> In this industry a machine can break. When it happens here, we tell you and we fix it. There is no third party to chase.', fr: '<strong>Chaque commande est traitée par nous, du début à la fin.</strong> Dans ce métier, une machine peut briser. Quand ça arrive chez nous, on vous le dit et on règle le problème. Aucun tiers à courir après.' },
    ...
    'quote.order.note': { en: 'Know exactly what you want? Pay securely by card or Affirm and skip the back-and-forth.', fr: 'Vous savez déjà exactement ce que vous voulez? Payez en toute sécurité par carte ou Affirm et évitez les échanges.' },
    'quote.lead.note': { en: 'No payment now — we\'ll email your quote within an hour during business hours.', fr: 'Aucun paiement maintenant — nous vous enverrons votre soumission par courriel en moins d\'une heure pendant les heures d\'ouverture.' },
    'quote.order.or': { en: 'or', fr: 'ou' },
    'quote.order.quoteinstead': { en: 'Get my free quote', fr: 'Obtenir ma soumission gratuite' },
    'quote.order.minqty.note': { en: 'Orders under 5 pieces are checkout-only — hit <strong>Order &amp; Pay Now</strong> below and you\'re done. Quote requests start at 5 pieces.', fr: 'Les commandes de moins de 5 pièces passent directement à la caisse — cliquez sur <strong>Commander et payer</strong> ci-dessous et c\'est réglé. Les demandes de soumission commencent à 5 pièces.' },
    'quote.tiers.h': { en: 'Blank quality', fr: 'Qualité du vêtement' },
    'quote.tiers.sub': { en: 'Pick a quality tier — we handle the blank. Price updates live; you can order right away.', fr: 'Choisissez un niveau de qualité — on s\'occupe du vêtement. Le prix se met à jour en direct; vous pouvez commander immédiatement.' },
    'quote.tiers.standard': { en: 'Standard', fr: 'Standard' },
    'quote.tiers.plus': { en: 'Plus', fr: 'Plus' },
    'quote.tiers.premium': { en: 'Premium', fr: 'Premium' },
    'quote.tiers.from': { en: 'From', fr: 'À partir de' },
    'quote.tiers.perunit': { en: '/unit', fr: '/unité' },
    'quote.tiers.colors': { en: 'colours', fr: 'couleurs' },
    'quote.qty.h': { en: 'How many do you need?', fr: 'Il vous en faut combien ?' },
    'quote.qty.k': { en: 'Quantity', fr: 'Quantité' },
    'quote.qty.sub': { en: 'A rough count is fine — you\'ll fine-tune exact sizes later. Quantity drives your per-unit price.', fr: 'Un nombre approximatif suffit — vous préciserez les tailles plus tard. La quantité détermine votre prix unitaire.' },
    'quote.qty.under5': { en: 'Under 5', fr: 'Moins de 5' },
    'quote.qty.pcs': { en: 'pcs', fr: 'pcs' },
    'quote.qty.popular': { en: 'Most popular', fr: 'Le plus populaire' },
    'quote.qty.save': { en: 'Save', fr: 'Économisez' },
    'quote.qty.each': { en: '/ea', fr: '/un.' },
    'quote.qty.under5note': { en: 'Under 5 pieces is checkout-only — order in a couple of clicks. Quote requests start at 5.', fr: 'Moins de 5 pièces passe directement à la caisse — commandez en quelques clics. Les soumissions commencent à 5.' },
    'quote.byo.link': { en: 'Bringing your own garments? Decoration-only pricing →', fr: 'Vous apportez vos propres vêtements ? Prix impression seulement →' },
    'quote.byo.short': { en: 'Your own garments — decoration only', fr: 'Vos propres vêtements — impression seulement' },
    'quote.byo.ctanote': { en: 'Decoration-only orders are confirmed by quote — we reply within the hour (9am–6pm), any quantity welcome.', fr: 'Les commandes impression seulement sont confirmées par soumission — réponse en moins d\'une heure (9 h à 18 h), toute quantité acceptée.' },
    'quote.tiers.tag.standard': { en: 'Reliable everyday quality', fr: 'Qualité fiable au quotidien' },
    'quote.tiers.tag.plus': { en: 'Retail fit & feel', fr: 'Coupe et toucher boutique' },
    'quote.tiers.tag.premium': { en: 'Heavyweight, premium feel', fr: 'Épais, toucher haut de gamme' },
    'quote.strip.units': { en: 'units', fr: 'unités' },
    'quote.strip.side': { en: 'side', fr: 'face' },
    'quote.strip.sides': { en: 'sides', fr: 'faces' },
    'quote.strip.startingat': { en: 'starting at', fr: 'à partir de' },
    'quote.strip.enterbelow': { en: 'enter sizes below', fr: 'saisissez les tailles ci-dessous' },
    'quote.strip.est': { en: 'est.', fr: 'est.' },
    'quote.ux.edit': { en: 'Edit', fr: 'Modifier' },
    ...
    'jersey.cz.liberos':      { en: 'liberos', fr: 'libéros' },
    'jersey.cz.goaliecolor':  { en: 'Goalie color', fr: 'Couleur du gardien' },
    'jersey.cz.liberocolor':  { en: 'Libero color', fr: 'Couleur du libéro' },
    'jersey.cz.goaliehint':   { en: 'Tick the box next to a player to give them this color.', fr: 'Cochez la case à côté d\'un joueur pour lui donner cette couleur.' },
    ...
    'cat.qty.note.bulk': { en: 'Per-unit price · 1 print side', fr: 'Prix unitaire · 1 côté imprimé' },
    'cat.qty.note.few': { en: 'One flat price · no minimum', fr: 'Prix fixe · aucun minimum' },
    ...
    'cat.cart.units.short': { en: 'in cart', fr: 'au panier' },
    'cat.cart.cta': { en: 'Continue to quote →', fr: 'Continuer vers la soumission →' },
    'cat.cart.cta.short': { en: 'Quote →', fr: 'Soumission →' },
    ...
    'cat.detail.customizehdr': { en: 'Customization', fr: 'Personnalisation' },
    'cat.detail.customizehint': { en: 'Add your logo or text', fr: 'Ajoutez votre logo ou texte' },
    ...
    'cat.card.view-details-cta': { en: 'View details & add', fr: 'Voir les détails et ajouter' },
    ...
    'cat.card.few-at-tier': { en: '1&ndash;4 items · no minimum', fr: '1&ndash;4 articles · aucun minimum' },
    ...
    'cat.share.sharedwithyou': { en: 'A design was shared with you', fr: 'Un design a été partagé avec vous' },
    'cat.share.sharedwithyousub': { en: 'Change the colour, placement or quantity — the artwork stays as it was sent.', fr: 'Changez la couleur, l\u2019emplacement ou la quantité — le visuel reste tel qu\u2019envoyé.' },
    ...
    'quote.cart.empty.title': { en: 'Start with a product type below', fr: 'Commencez par un type de produit ci-dessous' },
    ...
    // BYO line builder (2026-09-08) — customer-supplied garments as first-class
    // cart lines, mixable with catalog blanks in the same quote.
    'quote.product.byo':          { en: 'Bring Your Own',  fr: 'Apportez les vôtres' },
    'quote.product.byo.sub':      { en: 'You ship the garments', fr: 'Vous fournissez les vêtements' },
    'quote.byoline.title':        { en: 'Tell us about your garments', fr: 'Parlez-nous de vos vêtements' },
    'quote.byoline.sub':          { en: "You ship them to us, we decorate them. Describe what you're sending and we'll price the decoration.", fr: 'Vous nous les envoyez, nous les décorons. Décrivez ce que vous envoyez et nous chiffrons la décoration.' },
    'quote.byoline.desc':         { en: 'Garment type', fr: 'Type de vêtement' },
    'quote.byoline.material':     { en: 'Material', fr: 'Matière' },
    'quote.byoline.qty':          { en: 'How many', fr: 'Combien' },
    'quote.byoline.method':       { en: 'Decoration method', fr: 'Méthode de décoration' },
    'quote.byoline.dtg.l':        { en: 'DTG / DTF', fr: 'DTG / DTF' },
    'quote.byoline.dtg.s':        { en: 'Printed', fr: 'Imprimé' },
    'quote.byoline.emb.l':        { en: 'Embroidery', fr: 'Broderie' },
    'quote.byoline.emb.s':        { en: 'Stitched', fr: 'Brodé' },
    'quote.byoline.unsure.l':     { en: 'Not sure', fr: 'Je ne sais pas' },
    'quote.byoline.unsure.s':     { en: "We'll advise", fr: 'On vous conseille' },
    'quote.byoline.est':          { en: 'Decoration only · estimate', fr: 'Décoration seulement · estimation' },
    'quote.byoline.linetotal':    { en: 'Line total', fr: 'Total de la ligne' },
    'quote.byoline.note':         { en: 'Final number depends on artwork complexity, print size and deadline. Blanks are yours, so this covers decoration only.', fr: 'Le prix final dépend de la complexité du visuel, de la taille et du délai. Les vêtements sont les vôtres : ceci couvre la décoration seulement.' },
    'quote.byoline.add':          { en: 'Add these garments to my quote', fr: 'Ajouter ces vêtements à ma soumission' },
    'quote.byoline.multi':        { en: 'Add as many different garments as you need — and you can still add blanks from our catalog to the same quote.', fr: 'Ajoutez autant de vêtements différents que nécessaire — vous pouvez aussi ajouter des vêtements de notre catalogue à la même soumission.' },
    'quote.byoline.badge':        { en: 'Your garments', fr: 'Vos vêtements' },
    'quote.byoline.pending':      { en: 'Decoration priced with your quote', fr: 'Décoration chiffrée avec votre soumission' },
    'quote.byoline.err.desc':     { en: 'Tell us what the garments are so we can price the decoration.', fr: 'Dites-nous de quels vêtements il s’agit pour chiffrer la décoration.' },
    'quote.byoline.err.qty':      { en: 'How many garments are you sending?', fr: 'Combien de vêtements envoyez-vous ?' },
    'quote.byoline.nocheckout':   { en: 'Orders with your own garments are quoted, not checked out — we confirm the count and the blanks when they arrive. Tap “Get my free quote” and we\'ll come back within the hour.', fr: 'Les commandes avec vos propres vêtements sont chiffrées, pas payées en ligne — nous confirmons la quantité et les vêtements à leur arrivée. Touchez « Obtenir ma soumission gratuite » et nous revenons vers vous dans l’heure.' },
    ...
    'quote.contact.phone.invalid': { en: 'Please add a phone number we can reach you on — it’s the fastest way to confirm sizes and artwork.', fr: 'Veuillez indiquer un numéro de téléphone où vous joindre — c’est le moyen le plus rapide de confirmer les tailles et le visuel.' },
