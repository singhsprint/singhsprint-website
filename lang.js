...
var SP_LANG = (function() {
  ...
  var translations = {
    ...
    'home.faq.a3': { en: "Most orders are ready in 2-4 business days. Rush printing available for Montreal and West Island pickups. We'll give you an exact timeline upfront.", fr: 'La plupart des commandes sont prêtes en 2 à 4 jours ouvrables. Impression urgente disponible pour ramassage à Montréal et dans l\'Ouest-de-l\'Île. On vous donne un échéancier précis dès le départ.' },
    ...
    'cat.card.canadian': { en: '🇨🇦 Canadian', fr: '🇨🇦 Canadien' },
    ...
    'quote.cart.empty.sub': {
      en: '1,100+ Bella+Canvas, Gildan, Berne, Adidas, Canadian-made &amp; more. We\'ll pre-fill this quote, show live pricing as you change qty / sides, and skip the back-and-forth.',
      fr: '1 100+ Bella+Canvas, Gildan, Berne, Adidas, fabriqués au Canada et plus. On préremplira la soumission, on affiche le prix en direct et on évite les allers-retours.'
    },
    ...
    'quote.canadian.label': { en: 'All-Canadian made blanks', fr: 'Vêtements fabriqués au Canada' },
    'quote.canadian.surcharge': { en: '+$2/unit', fr: '+2 $/unité' },
    'quote.canadian.sub': { en: 'Locally sourced &amp; manufactured. Optional upgrade from the standard blanks.', fr: 'Source et fabrication locales. Mise à niveau facultative par rapport aux vêtements standards.' },
    ...
    'quote.bulk.canadianadd': { en: 'All-Canadian blanks add $2/unit on T-shirts and Long Sleeves.', fr: 'Les vêtements canadiens ajoutent 2 $/unité sur les T-shirts et manches longues.' },
    ...
    'rfp.comp.union': { en: 'Union-made / All-Canadian', fr: 'Syndiqué / 100 % canadien' },
