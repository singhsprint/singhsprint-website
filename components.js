...
function loadNav() {
  ...
  el.innerHTML = ''
    ...
    + '      <a href="https://singhsprint-crm.vercel.app/login" class="btn btn-outline btn-sm" style="padding:10px 20px;font-size:.85rem" data-i18n="nav.login">Login</a>'
